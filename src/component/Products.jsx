...
export default function Products({ Logo, Product, paddingTop, data, handleClick, reverseRow, id, Background }) {
    ...
    <div style={containerStyle} id={id} className={`flex flex-col ${reverseRow} h-screen ${paddingTop}`}>
      <div className={`h-full lg:h-[430px] md:w-1/2 flex flex-col justify-center items-center`}>
        <div className='flex flex-row justify-center items-center px-2'>
          <Slide>
            <img src={images[1]} alt="" className='md:h-[250px] md:ml-20 h-[100px] md:w-full cursor-pointer' onClick={() => handleClick(images[1])} />
          </Slide>
          <Slide>
            <img src={images[2]} alt="" className='md:h-[250px] ml-1 md:ml-10 h-[100px] md:w-[20rem]' onClick={() => handleClick(images[2])} />
          </Slide>
          <Fade>
            <img src={images[0]} alt="" className='md:h-[250px] h-[100px] md:w-[25rem]' onClick={() => handleClick(images[0])} />
          </Fade>
  ...
  wrapper="span"
  speed={50}
  className="md:text-6xl text-4xl font-heading font-bold text-black typing pt-10 md:ml-10"
  repeat={Infinity}
/>
