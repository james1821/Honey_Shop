...
export default function Products({ Logo, Product, padding, data, handleClick, reverseRow}) {

  const marginTopValue = padding ? `${padding}px` : '10';
 
  return (
    <div className={`flex flex-col md:flex-${reverseRow ? 'row-reverse' : 'row'} h-full md:mt-30 mt-10`}>
      <div id='Products' style={{ marginTop: marginTopValue }} className='h-full lg:h-[430px] md:w-1/2 flex flex-col justify-center items-center'>
